...
public class LeitorFigurinhasDesejadasPessoais {

    public void carregarFigurinhas(TreeSet<FigurinhasDesejadasPessoais> listaFigurinhasDesejadas) {
        try {
            BufferedReader leitor = new BufferedReader(
                    new FileReader("figurinhas_desejadas_pessoais.csv")
            );
            ...
            while ((linha = leitor.readLine()) != null) {
                ...
                if (dados.length == 6) {
                    ...
                    FigurinhasDesejadasPessoais figurinha = new FigurinhasDesejadasPessoais(
                            nomeSelecao,
                            numeroFigurinha,
                            nomeJogador,
                            descricao,
                    ...
                    listaFigurinhasDesejadas.add(figurinha);
                }
            }
