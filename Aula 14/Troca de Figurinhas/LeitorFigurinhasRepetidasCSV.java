...
public class LeitorFigurinhasRepetidasCSV {

    public void carregarFigurinhas(TreeSet<FigurinhasRepetidas> listaFigurinhasRepetidas) {
        try {
            BufferedReader leitor = new BufferedReader(
                    new FileReader("figurinhas_repetidas_pessoais.csv")
            );
